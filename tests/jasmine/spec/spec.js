describe('addTeam()', function() {
    ...
    it('should throw an error if incorrect number of properties used', function() {
        expect(function(){
            soccer.addTeam(missingProps);
        }).toThrow(new Error('Incorrect team property format passed.'));
    });
    
    it('should throw an error if incorrect property is used', function() {
        expect(function(){
            soccer.addTeam(incorrectprops);
        }).toThrow(new Error('Incorrect team property format passed.'));
    });
    
    it('should throw an error if team name is already in use', function() {
        soccer.addTeam(team);
